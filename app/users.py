...
if not SECRET:
    raise RuntimeError("SECRET not set. Copy .env.example to .env and set SECRET.")
...
bearer_transport = BearerTransport(tokenUrl="auth/jwt")
...
fastapi_users = FastAPIUsers[Users, UUID](get_user_manager, [auth_backend])
